...
import image from "../../public/greenmustaqeem.svg";

export const Mustaqeem = () => {
	return (
		<section id="6" className="mysection">
			{/* BACKGROUND IMAGE        */}
			<div className="newscard-section max-w-[1200px] rounded-2xl mx-auto	p-16 my-16 flex justify-center items-center bg-[#1D5948] text-white relative">
				{/* BACKGRROUND IMAGE  */}
				<Image
					src={image}
